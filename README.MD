...
to use specific from req.body we need to gave it modelname.methods.'function name like getname' = function (){retunr this .name} that will writtrn in models -->
to make the code easier use instance functions that not be needed to import , only call directly whenever you want, all in mongoose document